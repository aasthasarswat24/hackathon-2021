...
function updateCart(brownie) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', brownie).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var brownie = JSON.parse(btn.dataset.brownie);
    updateCart(brownie);
  });
...
if (order) {
  socket.emit('join', "order_".concat(order._id)); //order_1233(id) gives a unique room for every order
}

var adminAreaPath = window.location.pathname;
console.log(adminAreaPath);
if (adminAreaPath.includes('admin')) (0,_admin__WEBPACK_IMPORTED_MODULE_2__.default)(socket);
{
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfoodRealtime"] = self["webpackChunkfoodRealtime"] || [];
